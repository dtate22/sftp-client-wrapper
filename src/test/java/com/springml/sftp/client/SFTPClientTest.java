...
public class SFTPClientTest {
    ...
    private static final String HOST = "test.rebex.net"; // "ftp.ftp.com";
    ...
    public void copyTest() throws Exception {
        ...
        String a = sftpClient.copyToFTP("/home/dtate22/sample.csv", "/");
        assertTrue(true);
    }

    // @Test
    // public void copyTest() throws Exception {
    //     String copiedFilePath = sftpClient.copy(
    //         "/home/ec2-user/work/files/csv/", 
    //         "/home/sam/tmp/s");
    ...
    public void copyFileToFTPFileTest() throws Exception {
        ...
        sftpClient.copyToFTP("/home/dtate22/sample.csv", "sample.csv");
